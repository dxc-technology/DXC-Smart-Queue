...
class Constants {
  ...
  /// api routes
  static String apiBaseUrl = "https://mtahackathonsmartqueueb.azurewebsites.net/api/";

  static String reservationsUrl = "${apiBaseUrl}reservations";
  static String reservationCancellationUrl = "${apiBaseUrl}cancel_reservation";
  static String makeReservationUrl = "${apiBaseUrl}reserve";
  static String completeReservationUrl = "${apiBaseUrl}complete_reservation";
  static String locationsUrl = "${apiBaseUrl}locations";
  static String queueSearch = "${apiBaseUrl}search";


  static String _personId = 'e973d45cc5c911eaa2ba0242ac100002';

  static set personId(id) => _personId = id;

  static get personId => _personId;
